...
void Camera::MouseLook(int mouseX, int mouseY){
    ...
    m_viewDirection = glm::rotate(m_viewDirection, glm::radians(-mouseDelta.x * 0.1f), m_upVector);
    glm::vec3 rightVector = glm::cross(m_viewDirection, m_upVector);
    m_viewDirection = glm::rotate(m_viewDirection, glm::radians(-mouseDelta.y * 0.1f), rightVector);
