...
//This hpp is taken from Prof. Mike Shah. He released this hpp file as part of the assignment.
//The implementation of camera was done by me as part of the assignment.
